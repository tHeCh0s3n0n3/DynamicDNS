...
if __name__ == "__main__":
    ...
    parser.add_argument("-u", "--url", help="URL to trigger the update", required=True)
    parser.add_argument("-c", "--credentials", help="Credentials to use in the HTTP Authorization header (username:password)", required=True)
    parser.add_argument("-s", "--subdomains", help="Subdomains to update separated by a comma \",\"", required=True)
